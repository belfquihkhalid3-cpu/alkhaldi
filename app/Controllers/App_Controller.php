...
class App_Controller extends Controller {
    ...
    public $Fuel_consumption_model;
    public $Locations_model;
    public $Vehicles_model;
    public $Maintenance_model;
    public $Chauffeur_payments_model;
    public $Jawaz_model;
    public $Chauffeur_documents_model;
    ...
    private function get_models_array() {
        ...
        'Vehicles_model',
        'Maintenance_model',
        'Chauffeur_payments_model',
        'Jawaz_model',
        'Chauffeur_documents_model','Voitures_contrat_model'
        );
    }
