...
class Dashboard extends Security_Controller {
    ...
    // Pour l'instant, on donne la permission à tout le monde (true).
    // Plus tard, vous pourrez ajouter une condition if() pour les permissions.
    $widget["mise_a_dispo_recente"] = true;
        return $widget;
    }
    ...
    private function _get_widgets_for_staffs($widget, $widgets_array) {
        if (get_array_value($widgets_array, $widget)) {
          ...
          else if ($widget == "mise_a_dispo_recente") {
        return mise_a_dispo_recente_widget();
    }
