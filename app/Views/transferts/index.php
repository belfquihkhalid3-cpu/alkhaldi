        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                echo modal_anchor(get_uri("transferts/modal_add"), 
                    ...
                    ["class" => "btn btn-primary", "title" => "Cr�er un nouveau transfert"]);
                ?>
            </div>
        </div>
            ...
            <table id="transferts-table" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th><i data-feather="map-pin" class="icon-16"></i> Itin�raire</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <?php if (isset($statistics)): ?>
            console.log('Statistiques charg�es:', <?php echo json_encode($statistics); ?>);
        <?php else: ?>
            console.error('Statistiques non charg�es!');
        <?php endif; ?>
        ...
        <?php else: ?>
            console.error('Statuts dropdown non d�fini!');
        <?php endif; ?>
        ...
        var table = $("#transferts-table").appTable({
            ...
            onInitComplete: function () {
                console.log('Table initialis�e, activation des ic�nes Feather...');
                feather.replace();
            },
            ...
            drawCallback: function() {
                // ? Appel� � chaque redraw du tableau (comme dans Jawaz)
                feather.replace();
            }
        });
        ...
        $('#statut_filter, #type_filter').on('change', function() {
            console.log('Filtre chang�:', $(this).attr('id'), '=', $(this).val());
            updateTable();
        });
        ...
        $(document).on('click', '.change-statut', function() {
            ...
            console.log('Changement statut demand�:', id, '->', statut);
            ...
            var titres = {
                ...
                'en_cours': 'D�marrer le transfert', 
            ...
            // R�activer les ic�nes dans le modal
            setTimeout(function() {
                feather.replace();
            }, 100);
        });
        ...
        console.log('Module transferts compl�tement initialis� - SANS Feather replace');
        
        // PAS d'observer - Feather est cass�
        console.log('Emojis utilis�s � la place des ic�nes Feather cass�es');
       // Forcer le remplacement des icônes toutes les secondes
