    ...
    <div class="card">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php
                // CORRECTION: S'assurer que le bouton "Ajouter" n'envoie pas d'ID
                echo modal_anchor(get_uri("jawaz/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> Nouveau Badge", 
